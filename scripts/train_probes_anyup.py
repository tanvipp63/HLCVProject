...
cache = FeatureCache(Path(config["cache_dir"]) / "anyup")
...
if __name__ == "__main__":
    ...
    print("Starting train_probes_anyup.py (AnyUp-enhanced features)", flush=True)
    ...
    for layer in args.layers:
        ...
        print(f"AnyUp feature datasets loaded for layer={layer}.", flush=True)
        ...
        print(f"Trainer initialized for layer={layer}. Beginning training on AnyUp features.", flush=True)
        ...
        for epoch in range(args.num_epochs):
            ...
            print(
                f"\n========== Epoch {epoch + 1}/{args.num_epochs} (AnyUp) ==========",
                flush=True,
            )
        ...
        print(f"AnyUp training complete for layer={layer}.")
